...
# Класс - это описание того как должен выглядит объект, то есть в классе мы описываем какими свойствами(данными) и поведением(функции) должен обладать объект

# Объект -> это сущность которую мы создаем от класса, у объекта есть собственные состояние свойств(данные)

# Целью создания было создать данные с функциями которые управляли этими данными
...
# billal = Human('Billal', 'Lanister', 'Programmist', 'Kyrgyz Republic')
