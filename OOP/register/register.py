...
# DIR_PATH = os.getcwd()
# FILE_PATH = DIR_PATH + '/register/users.json'
...
#                 except IndexError:
#                     raise ValueError('Invalid password o username!')
                
#                 user_password = user['password']['password'].encode('latin-1')
#                 sakt = user['password']['salt'].encode('latin-1')
...
# obj.register('JohnSnow25', 'John', 'Snow', 'bastard123', 'bastard123')
