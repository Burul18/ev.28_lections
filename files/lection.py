...
# Процессы Сериализации и Десериализация данных (конвертация)

# Сериализация (это запись данных в JSON) - Это перевод из Python в JSON формат

# dump - записывает в файл формата JSON
# dumps - записывает данные в текст формата JSON

# Десериализация (чтение данных из JSON) - это процесс перевода из JSON в Py dict

# load - это функция которая считывает данные из файлa JSON
