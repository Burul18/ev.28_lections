...
#     print(a, 'is started in param a')
#     print(b, 'is started in param b')
#     print(c, 'is started in param c')
...
# print(sum_of_args(5, 10, 15, 20)) # arguments(позиционн. аргументы)
